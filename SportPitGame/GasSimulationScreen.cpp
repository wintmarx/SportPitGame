...
GasSimulationScreen::GasSimulationScreen(int width, int height) : Screen(width, height)
{
...
GasSimulationScreen::~GasSimulationScreen()
{
}

void GasSimulationScreen::Collider(Unit **donuts)
{
	double distance;
...
void GasSimulationScreen::Update(float delta)
{
	for (int i = 0; i < count; i++)
	{
...
void GasSimulationScreen::Render(Graphics *graphics)
{
...
void GasSimulationScreen::OnKeyPress(int buttonID, bool isPressed)
{
...
void GasSimulationScreen::OnKeyRelease(int buttonID)
{

}

void GasSimulationScreen::Initialize()
{
